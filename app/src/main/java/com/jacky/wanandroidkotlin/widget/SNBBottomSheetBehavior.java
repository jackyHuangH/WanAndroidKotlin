...
public class SNBBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private SNBNestedScrollView snbNestedScrollView;
    ...
    public void setOutsideView(SNBNestedScrollView outsideView) {
        this.snbNestedScrollView = outsideView;
    }
    ...
    private void scrollOutsideView(int dy) {
        if (snbNestedScrollView != null && slideByOutsideView) {
            snbNestedScrollView.setScrollByOutsideView(true);
            snbNestedScrollView.scrollBy(0, dy);
        }
